...
VALUES ( 3, 5, '2018-05-04', NULL , '2018-05-04', '2019-01-01', 2000, 2000, false, NULL , 0.5, now(), now());
--entrada fermento
INSERT INTO public.lotes(
  producto_id,"tipoLote", "fechaInicio", "fechaInicioMaduracion", "fechaFinalizacion", "fechaVencimiento", "cantidadElaborada", "cantidadFinal", "tipoTP", asignatura, costounitario, created_at, updated_at)
VALUES ( 4, 5, '2018-05-04', NULL , '2018-05-04', '2018-10-01', 1000, 1000, false, NULL , 0.1 , now(), now());
--entrada leche
INSERT INTO public.lotes(
  producto_id,"tipoLote", "fechaInicio", "fechaInicioMaduracion", "fechaFinalizacion", "fechaVencimiento", "cantidadElaborada", "cantidadFinal", "tipoTP", asignatura, costounitario, created_at, updated_at)
VALUES ( 2, 5, '2018-05-04', NULL , '2018-05-04', '2018-10-01', 100, 100, false, NULL , 0.1 , now(), now());
...
INSERT INTO public.lotes(
	 producto_id, "tipoLote", "fechaInicio", "fechaInicioMaduracion", "fechaFinalizacion", "fechaVencimiento", "cantidadElaborada", "cantidadFinal", "tipoTP", asignatura, costounitario, created_at, updated_at)
	VALUES ( 3, 5, '2018-05-06', NULL , '2018-05-06', '2019-01-01', 2000, 2000, false, NULL , 0.5, now(), now());
--entrada fermento
INSERT INTO public.lotes(
	 producto_id,"tipoLote", "fechaInicio", "fechaInicioMaduracion", "fechaFinalizacion", "fechaVencimiento", "cantidadElaborada", "cantidadFinal", "tipoTP", asignatura, costounitario, created_at, updated_at)
	VALUES ( 4, 5, '2018-05-06', NULL , '2018-05-06', '2018-10-01', 1000, 1000, false, NULL , 0.1 , now(), now());
