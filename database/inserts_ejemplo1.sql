...
VALUES ( 1, 1, '2018-05-06 00:00:01' , 3, 0, 2000, 2000, 2000, 1, NULL , now(), now());

INSERT INTO public.movimientos(
  "idLoteConsumidor", "idLoteIngrediente", fecha, producto_id, debe, haber, saldoglobal, "saldoLote", tipo, planificacion_id, created_at, updated_at)
VALUES ( 2, 2, '2018-05-06 00:00:02', 4, 0, 1000, 1000, 1000, 1, NULL , now(), now());

--consumo planif sal
INSERT INTO public.movimientos(
  "idLoteConsumidor", "idLoteIngrediente", fecha, producto_id, debe, haber, saldoglobal, "saldoLote", tipo, planificacion_id, created_at, updated_at)
VALUES ( 3, NULL , '2018-05-07 00:00:01', 3, 1000, 0, 1000, NULL , 9, NULL , now(), now());

--consumo planif fermento
INSERT INTO public.movimientos(
  "idLoteConsumidor", "idLoteIngrediente", fecha, producto_id, debe, haber, saldoglobal, "saldoLote", tipo, planificacion_id, created_at, updated_at)
VALUES ( 3, NULL , '2018-05-07 00:00:02', 4, 500, 0, 500, NULL , 9, NULL , now(), now());

--consumo planif leche
INSERT INTO public.movimientos(
  "idLoteConsumidor", "idLoteIngrediente", fecha, producto_id, debe, haber, saldoglobal, "saldoLote", tipo, planificacion_id, created_at, updated_at)
VALUES ( 3, NULL , '2018-05-07 00:00:03', 2, 10, 0, -10, NULL , 9, NULL , now(), now());

--Entrada producto planif Queso sardo
INSERT INTO public.movimientos(
  "idLoteConsumidor", "idLoteIngrediente", fecha, producto_id, debe, haber, saldoglobal, "saldoLote", tipo, planificacion_id, created_at, updated_at)
VALUES ( 3, 3, '2018-05-07 00:00:05', 1, 0, 5, 5, 5, 8, 1, now(), now());
